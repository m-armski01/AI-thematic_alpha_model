...
611 signal dates. Macro gate in **block-increases** mode: risk-off on 172 signal dates, 276 increases or entries blocked (that weight stayed in cash; exempt names: none). The scale factors and `min_exposure` are unused in this mode. The gate was evaluated on 142 of the 611 signal dates (monthly) and held constant in between; ranking stayed weekly. Event mask: **8 entries blocked pre-earnings** (323 ticker-dates masked; 0 tickers without earnings dates failed open).
...
|---|---:|---:|---:|---:|
| Total return | 6712.9% | 364.5% | 7474.4% | 6780.2% |
| CAGR | 42.0% | 13.6% | 43.3% | 42.2% |
| Annualized volatility | 32.3% | 18.4% | 31.2% | 34.0% |
| Sharpe (excess over DTB3) | 1.18 | 0.67 | 1.24 | 1.14 |
| Sortino (MAR 0) | 1.76 | 0.95 | 1.82 | 1.67 |
| Max drawdown | -42.4% | -33.5% | -46.7% | -55.2% |
| Max DD peak | 2024-06-18 | 2020-02-19 | 2021-12-27 | 2022-01-03 |
| Max DD trough | 2025-04-21 | 2020-03-23 | 2022-12-28 | 2022-12-28 |
| Max DD recovery | 2025-07-17 | 2021-01-07 | 2023-07-05 | 2024-02-09 |
| Max DD duration (days) | 394 | 323 | 555 | 767 |
| Calmar | 0.99 | 0.41 | 0.93 | 0.76 |
| Alpha vs S&P 500 (ann.) | 23.6% | -0.1% | 22.6% | 23.0% |
| Beta vs S&P 500 | 1.18 | 1.00 | 1.30 | 1.28 |
...
| Excess kurtosis (daily) | 4.78 | 11.29 | 3.70 | 3.42 |
...
| Annualized turnover | 4.06 | 0.08 | 0.62 | 15.39 |
| Total costs paid | 3,853.78 | 7.99 | 1,229.48 | 13,034.81 |
| Costs as % of final equity | 0.57% | 0.02% | 0.16% | 1.89% |

Against equal-weight buy-and-hold of the same basket the strategy's CAGR is lower (42.0% vs 43.3%), its Sharpe is lower (1.18 vs 1.24), and its maximum drawdown is shallower (-42.4% vs -46.7%). The rules gave up total return relative to holding the basket in exchange for a better risk-adjusted profile.

VaR note: parametric (normal) 99% VaR is 4.6% against a historical 5.5%; daily excess kurtosis is 4.78. The normal assumption understates the tail.
...
|---|---:|---:|---:|---:|---:|
| Strategy | 3.30 | 0.59 | 0.00 | 0.17 | 4.06 |
...
|---|---:|---:|
| Total return | 6712.9% | 6703.9% |
| CAGR | 42.0% | 42.0% |

FX contribution: 0.0% per year of CAGR; in total the EUR result differs from the local-currency result by 9.0% of initial capital. Positions are unhedged USD and KRW exposure held by a EUR investor.
