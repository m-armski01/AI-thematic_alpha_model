...
| Macro gate | block increases while any sub-gate is engaged (VIX>25 (release 20); 10y +40bp (release 32bp)/21d; WTI +20% (release 16%)/21d); exempt segments: defensive; scale factors and floor unused |
...
|---|---:|---:|---:|---:|
| Total return | 6156.9% | 364.5% | 7474.4% | 6780.2% |
| CAGR | 41.0% | 13.6% | 43.3% | 42.2% |
| Annualized volatility | 32.8% | 18.4% | 31.2% | 34.0% |
| Sharpe (excess over DTB3) | 1.15 | 0.67 | 1.24 | 1.14 |
| Sortino (MAR 0) | 1.70 | 0.95 | 1.82 | 1.67 |
| Max drawdown | -43.4% | -33.5% | -46.7% | -55.2% |
| Max DD peak | 2024-06-18 | 2020-02-19 | 2021-12-27 | 2022-01-03 |
| Max DD trough | 2025-04-21 | 2020-03-23 | 2022-12-28 | 2022-12-28 |
| Max DD recovery | 2025-08-07 | 2021-01-07 | 2023-07-05 | 2024-02-09 |
| Max DD duration (days) | 415 | 323 | 555 | 767 |
| Calmar | 0.95 | 0.41 | 0.93 | 0.76 |
| Alpha vs S&P 500 (ann.) | 22.6% | -0.1% | 22.6% | 23.0% |
| Beta vs S&P 500 | 1.22 | 1.00 | 1.30 | 1.28 |
| Historical VaR 95% (daily) | 3.2% | 1.7% | 3.2% | 3.3% |
| Historical VaR 99% (daily) | 5.5% | 3.3% | 5.3% | 5.8% |
| Parametric VaR 95% (daily) | 3.2% | 1.8% | 3.1% | 3.4% |
| Parametric VaR 99% (daily) | 4.6% | 2.6% | 4.4% | 4.8% |
| CVaR / ES 95% (daily) | 4.8% | 2.8% | 4.6% | 5.0% |
| Excess kurtosis (daily) | 4.36 | 11.29 | 3.70 | 3.42 |
| Hit rate (weekly periods) | 58.5% | 60.3% | 61.7% | 60.4% |
| Average win (weekly period) | 3.7% | 1.7% | 3.5% | 3.8% |
| Average loss (weekly period) | -3.4% | -1.8% | -3.5% | -3.7% |
| Annualized turnover | 4.21 | 0.08 | 0.62 | 15.39 |
| Total costs paid | 3,842.77 | 7.99 | 1,229.48 | 13,034.81 |
| Costs as % of final equity | 0.61% | 0.02% | 0.16% | 1.89% |

Against equal-weight buy-and-hold of the same basket the strategy's CAGR is lower (41.0% vs 43.3%), its Sharpe is lower (1.15 vs 1.24), and its maximum drawdown is shallower (-43.4% vs -46.7%). The rules gave up total return relative to holding the basket in exchange for a better risk-adjusted profile.

VaR note: parametric (normal) 99% VaR is 4.6% against a historical 5.5%; daily excess kurtosis is 4.36. The normal assumption understates the tail.
...
|---|---:|---:|---:|---:|---:|
| Strategy | 3.42 | 0.59 | 0.00 | 0.20 | 4.21 |
...
Macro gate: 72 state transitions over 611 signal dates (6.0 per year); 21 of them reverse within 1 signal date and 29 within 2. The gate accounts for 0.0% of the strategy's turnover. In block mode a blocked *entry* that executes after the release is membership turnover, not gate turnover, so this share only counts blocked increases of held names; with equal weights and a full book those are rare, and the gate's effect shows up as deferred membership and higher cash instead.
...
|---|---:|---:|
| Total return | 6156.9% | 5826.9% |
| CAGR | 41.0% | 40.4% |

FX contribution: 0.6% per year of CAGR; in total the EUR result differs from the local-currency result by 330.0% of initial capital. Positions are unhedged USD and KRW exposure held by a EUR investor.
...
| -41.5% | 2021-11-25 | 2022-12-28 | 2023-05-30 | 551 |
| -33.8% | 2020-02-19 | 2020-03-16 | 2021-04-07 | 413 |
